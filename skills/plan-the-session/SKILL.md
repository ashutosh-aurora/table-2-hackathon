---
name: plan-the-session
description: Start-of-day self-diagnosis that proposes a tailored plan and time allocation for the table. Use first, before any problem or solution work. Adapts the journey to the team rather than prescribing a fixed sequence.
---
...
A short written plan — the table's position, who's doing what, the time allocation — saved to
`feature/plan.md`. Then move to `land-on-problem`.
